...
class Class_Marks:
    def __init__(self, root, ls, frame_old):
        ...
        lbl_sub1 = Label(Manage_Frame, text="Maths : ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub2 = Label(Manage_Frame, text="English: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub3 = Label(Manage_Frame, text="Kiswahili: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub4 = Label(Manage_Frame, text="Social studies: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub5 = Label(Manage_Frame, text="C.R.E : ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        lbl_sub6 = Label(Manage_Frame, text="Music: ", bg="LightBlue", fg="RED", font=("times new roman", 14, "bold"))
        ...
        self.Student_table = ttk.Treeview(Table_Frame,
                                          columns=("Roll", "MAT", "ENG.", "KIS.", "SOC", "C.R.E", "MUS"),
